...
class TaxVatNumberPage extends StatelessWidget {
  const TaxVatNumberPage({super.key});
  ...
  GestureDetector _buildVerificationDocumentTypeButton(
    BecomeProBuyerPageController controller, {
  ...
  GetBuilder _buildSelectCountryForDocumentVerification(
    ...
    return GetBuilder<BecomeProBuyerPageController>(
      builder: (controller) {
        return GestureDetector(
          onTap: () {
            Get.bottomSheet(
